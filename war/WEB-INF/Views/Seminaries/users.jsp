...
<%@ page import="model.entity.Seminary"%>
...
<head>
  ...
  <title>Usuarios Registrados en este seminario</title>
...
<a>
	...
	<div class="container" style="background-color: #FFFFFF;">
			...
			<table width="100%" style="border:2px; border-color: #000000;">
  				<tr>
  				<td width="30%">
  				...
  				<td>
  				<% if (users.size() > 0) { %>
				<span class="heading">Usuarios inscritos: <%= users.size() %> </span>
			...
			<% } else { %>
			<span class="heading">No hay nadie inscrito en este seminario</span>
			<% } %>
