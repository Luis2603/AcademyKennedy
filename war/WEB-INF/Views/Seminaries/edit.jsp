			...
			<tr>
				<td>
					<h2 align="center">Actions</h2>
  					<h4 align="center"><a href="/seminaries">Ver Seminarios Programados</a></h4>
					<form method="post" action="/seminaries/edit">
						<input type="hidden" name="semID" value="<%= editable.getId() %>">
						
						<label>Curso:</label>							
						<input type="text" name="course"required value="<%= editable.getCourse() %>">
						
						<label>Profesor a cargo:</label>
						<input type="text" name="teacher" required value="<%= editable.getTeacher() %>">
						
						<label>Aula:</label> 
						<input type="text" name="classroom" required value="<%= editable.getClassroom() %>">
						
						<label>Fecha:</label>
						<input type="text" name="date" required value="<%= editable.getDate() %>">
						
						<label>Hora:</label>
						<input type="text" name="hour" required value="<%= editable.getHour() %>">
						
						<input id="botonsubmit" type="submit" value="Guardar">
