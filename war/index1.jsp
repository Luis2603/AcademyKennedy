          ...
          <div class="navbar-collapse collapse">
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a href="index1.html" class="active">Inicio</a></li>
            ...
            <div class="row slide-margin">
              <div class="col-sm-6">
                <div class="carousel-content">
                  <h2 class="animation animated-item-1">Welcome <span>Kennedy</span></h2>
                  <p class="animation animated-item-2"><a href="https://github.com/Luis2603/AcademyKennedy">Codigo fuente...</p>
