...
public class UsersControllerAdd extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		RequestDispatcher var = this.getServletContext().getRequestDispatcher("/WEB-INF/Views/Users/add1.jsp");
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		RequestDispatcher var = getServletContext().getRequestDispatcher("/WEB-INF/Views/Users/add1.jsp");
		try {
			var.forward(req, resp);
